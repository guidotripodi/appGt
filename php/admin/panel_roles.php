                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									$select_stmt=$db->prepare("SELECT rol,id FROM rol");
									$select_stmt->execute();
									...
									?>
                                        <tr>
            								...
            								<td width="4%"><?php echo '<a href="modificar_rol.php?id='.$row["id"].'"><button class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button></a>'?></td>
											<td width="7%"><?php echo '<a href="delete_rol.php?id='.$row["id"].'"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>'?></td>
                                        </tr>
									<?php 
									}
									?>
