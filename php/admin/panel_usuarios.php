                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
									...
									$select_stmt=$db->prepare("SELECT user,pass,rol,id FROM log");
									$select_stmt->execute();
									...
									?>
                                        <tr>
                                            ...
                                            <td>*******</td>
											<td width="4%"><?php echo '<a href="modificar_usuario.php?id='.$row["id"].'"><button class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></button></a>'?></td>
											<td width="7%"><?php echo '<a href="delete_usuario.php?id='.$row["id"].'"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></button></a>'?></td>
                                        </tr>
									<?php 
									}
									?>
